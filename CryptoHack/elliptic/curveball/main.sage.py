...
def main():
    ...
    # Curve order
    qq = _sage_const_0xFFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551 
    ...
    # Bing's public key
    public_key = EC(
        _sage_const_0x3B827FF5E8EA151E6E51F8D0ABF08D90F571914A595891F9998A5BD49DFA3531 ,
        _sage_const_0xAB61705C502CA0F7AA127DEC096B2BBDC9BD3B4281808B3740C320810888592A ,
    )
    private_key = int(_sage_const_3 )
    new_G = list(public_key.division_points(private_key)[_sage_const_0 ].xy())
    new_G = [int(new_G[_sage_const_0 ]), int(new_G[_sage_const_1 ])]
    packet = {
        "private_key": private_key,
        "host": "www.bing.com",
        "public_key": [
            int('0x3B827FF5E8EA151E6E51F8D0ABF08D90F571914A595891F9998A5BD49DFA3531', _sage_const_16 ),
            int('0xAB61705C502CA0F7AA127DEC096B2BBDC9BD3B4281808B3740C320810888592A', _sage_const_16 ),
        ],
        "generator": new_G,
        "curve": "secp256r1",
    }
